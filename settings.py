...
TWITTER_CONSUMER_SECRET = '123' # open(op.join(HERE, 'twitter_consumer_secret')).read().strip()

FACEBOOK_API_KEY = '0bdf577fe3dc898fc740a3999a1f1ce0'
FACEBOOK_SECRET = '123'  # open(op.join(HERE, 'facebook_consumer_secret')).read().strip()
